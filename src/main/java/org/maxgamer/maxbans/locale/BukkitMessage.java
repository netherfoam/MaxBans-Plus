 ...
 * TODO: Document this
 */
public class BukkitMessage implements Message<BukkitMessage> {
    protected Locale locale;
    protected Map<String, Object> substitutions;
    protected String templateId;
    protected BukkitMessage next;

    public BukkitMessage(Locale locale, Map<String, Object> substitutions, String templateId) {
        this.locale = locale;
        this.substitutions = new HashMap<>(substitutions);
        this.templateId = templateId;
    }

    public BukkitMessage append(BukkitMessage suffix) {
        this.next = suffix;

        return this;
    }

    public BukkitMessage insert(BukkitMessage prefix) {
        prefix.next = this;
