 ...
 * @author netherfoam
 */
public class BukkitMessageBuilder implements MessageBuilder {
    protected Locale locale;
    protected Map<String, Object> substitutions = new HashMap<>(6);

    public BukkitMessageBuilder(Locale locale) {
        this.locale = locale;
    }
    ...
    public Message get(String templateId) {
        return new BukkitMessage(locale, substitutions, templateId);
    }
